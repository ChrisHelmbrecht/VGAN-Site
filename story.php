...
<section class="sub-hero">
  ...
  <div class="wrap sub-hero-inner">
    ...
    <p><?= tv('story_hero_p','Premium chocolate that happens to be dairy-free — born in Norway, made for people who just want seriously good chocolate.') ?></p>
  </div>
</section>
...
<section class="section prose-sec">
  <div class="wrap prose">
    ...
    <p><?= tv('story_p2','We come from a world of snow, boards and open air, where doing things your own way is the whole point. That free-thinking spirit runs through everything we make: full of flavour, uncompromising, a little rebellious and unmistakably ours. We call it <strong>Joyful Rebellion</strong> — indulgence without the guilt trip, and never boring.') ?></p>
    <p><?= tv('story_p3','Today you\'ll find our bars on more and more shelves in the US, and with people far outside the vegan world — people who aren\'t necessarily looking for vegan chocolate. They just want seriously good chocolate, made a better way. That\'s the whole idea. And we\'re only getting started.') ?></p>
  </div>
</section>
  ...
  <div class="wrap prose">
    ...
    <div class="feature-row">
      <div class="feature">
        ...
        <p><?= tv('story_f1_p','We didn\'t set out to make "good vegan chocolate." We set out to make seriously good chocolate — premium, organic, and ready to go head-to-head with anything on the shelf. The dairy-free part should almost be a bonus.') ?></p>
      </div>
      <div class="feature">
        <h3><?= tv('story_f2_h','Not just for vegans') ?></h3>
        <p><?= tv('story_f2_p','Our bars aren\'t made for a diet. They\'re for anyone who wants seriously good chocolate, made a better way. Dairy-free helps lower the carbon footprint; taste is why you come back.') ?></p>
      </div>
      <div class="feature">
        <h3><?= tv('story_f3_h','Traceability, not big words') ?></h3>
        <p><?= tv('story_f3_p','Organic cocoa from long-term partnerships in the same growing regions, a supply chain we keep working to make more traceable, and a carbon footprint we actually measure. Documentation over big promises. Read more on our <a href="environment.php">sustainability page</a>.') ?></p>
      </div>
    </div>
  </div>
</section>
